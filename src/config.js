const config = {
    API_BASE_URL: "http://localhost:4000", // ketika proxy diaktifkan untuk menangani cors, setup self host di sini.
    BASE_URL: "http://localhost:4000", // ketika proxy diaktifkan untuk menangani cors, setup self host di sini.
    API_ENDPOINT_LOGIN: "/user/signin",
